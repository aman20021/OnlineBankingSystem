...
INSERT INTO `customer` (`cust_id`,`dob`,`first_name`,`last_name`,`phone_no`,`email`,`cust_address_state`,`cust_address_city`,`cust_address_pincode`,`pan_no`,`account_no`)
VALUES
  (11,"2011-08-10","Alvin","Burton","9014226243","fringilla.mi@aol.ca","P.O. Box 971, 2372 Lorem Rd.","Haridwar",483662,"0534513947",003886),
  (12,"2001-08-22","Lucy","Shaffer","9454748028","ante.dictum@outlook.edu","711-1950 Varius Av.","Ichalkaranji",543918,"6815922224",982729),
  (13,"2013-09-09","Acton","Nelson","9045988371","est.mollis@hotmail.com","928-3021 Pede St.","Gangtok",321074,"5288028138",931476),
  (14,"2002-11-09","Hedy","Burns","9947347218","aliquet.lobortis@google.net","Ap #256-273 Velit Rd.","Vishakhapatnam",468623,"7828148212",107953),
  (15,"2014-03-30","Angela","Lamb","9206784875","maecenas.mi@google.edu","Ap #745-4427 Morbi Ave","Bulandshahr",767788,"2626184773",739637),
  (16,"2010-12-24","Xanthus","Pope","9559184177","consequat.nec@yahoo.net","Ap #344-5672 Et Rd.","Alwar",994740,"6133172468",543220),
  (17,"2001-12-06","Irma","Rodriquez","9412041249","scelerisque@aol.edu","4218 Aliquam Rd.","Haridwar",234763,"3591034507",540211),
  (18,"2016-10-31","Igor","Burch","9654695764","a.odio.semper@aol.com","Ap #519-3470 Etiam Avenue","Daman",745850,"8616123513",703863),
  (19,"2005-11-27","Lisandra","Holloway","9641617227","inceptos.hymenaeos@outlook.ca","Ap #766-9451 Mauris, Ave","Chandigarh",658523,"4629337573",850353),
  (20,"2022-08-30","Noelle","Quinn","9218862229","nec.ante.blandit@yahoo.net","9728 Arcu. Street","Silvassa",573497,"7225416241",346158);
...
INSERT INTO `employee` (`emp_id`,`first_name`,`last_name`,`salary`,`emp_type`,`emp_dob`,`phone_no`,`emp_address_state`,`emp_address_city`,`emp_address_pincode`,`mgr_id`)
VALUES
  (1010,"Gemma","Oneal",138005,"Bank Clerk","1996-04-17","9357877485","Ap #519-692 Integer Rd.","Bettiah",150978,11),
  (1011,"Kristen","Poole",102014,"IT","1996-04-27","9483353509","Ap #757-6244 Dolor, St.","Nellore",470472,12),
  (1012,"Serena","Chang",162316,"Bank Clerk","1996-04-30","9306107365","670-7164 Malesuada Avenue","Navsari",564079,13),
  (1013,"Hope","Patton",192403,"Manager","1996-04-09","9617844323","Ap #274-7347 Eu Av.","Raichur",844373,14),
  (1014,"Karyn","Strong",101986,"IT","1996-04-13","9575136713","5645 Nunc. Av.","Kohima",945679,15),
  (1015,"Maggy","Tyson",190832,"Bank Clerk","1996-05-08","9278472054","1696 Placerat. Road","Haridwar",623053,16),
  (1016,"Drew","Hansen",172699,"Manager","1996-04-21","9435126622","P.O. Box 745, 3327 Natoque Rd.","Agartala",145892,17),
  (1017,"Alyssa","Bowman",173755,"Manager","1996-04-02","9889471385","325-3060 Nibh Av.","Daman",536731,18),
  (1018,"Gay","Alexander",191596,"Manager","1996-04-10","9947292027","Ap #800-7793 Sed Road","Shillong",171035,19),
  (1019,"Sydnee","Mueller",158692,"Manager","1996-04-24","9143381347","772-2145 Diam Av.","Port Blair",412551,20);
